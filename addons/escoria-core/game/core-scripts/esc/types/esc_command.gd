...
var _running_command_impl: ESCBaseCommand = null
...
func run() -> int:
	...
	_running_command_impl = command_object
...
func interrupt():
	...
	if _running_command_impl and _running_command_impl.has_method("interrupt"):
		_running_command_impl.interrupt()
