...
##
## Executes the animation specified in "name" on "object" without blocking. The next command in the event will be executed immediately after the animation is started.[br]
## [br]
## #### Parameters[br]
## [br]
...
## |name|`String`|Name of the animation to start on the object.|yes|[br]
